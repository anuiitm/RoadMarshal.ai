...
function CategoryCard({ id, catalog, value, onChange }) {
    ...
    const categoryStateToRows = (state)=>{
        ...
        Object.values(state).forEach((typeState)=>{
            typeState.rows.forEach((row)=>{
                // Find which issue this row belongs to by checking subtypes
                let issue = "";
                Object.entries(catalog?.[id] || {}).forEach(([subtypeName, subtypeObj])=>{
                    if (Array.isArray(subtypeObj.problems) && row.problems.some((p)=>subtypeObj.problems.includes(p))) {
                        // Find the issue that matches the problems
                        row.problems.forEach((prob)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            rows.map((row, i)=>{
                const subtypesAvailable = row.issue && catalog?.[category]?.[row.issue] ? catalog[category][row.issue]["problems"] || [] : [];
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__855d5871._.js.map
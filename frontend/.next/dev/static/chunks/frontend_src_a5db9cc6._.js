...
function CategoryCard(t0) {
    ...
    if ($[0] !== "1f3847022b95d68832dec9e2ca78d2d371fe83aaf213e312d1ddd8ae7ffefea1") {
        for(let $i = 0; $i < 35; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1f3847022b95d68832dec9e2ca78d2d371fe83aaf213e312d1ddd8ae7ffefea1";
    }
    ...
    if ($[1] !== catalog || $[2] !== id) {
        t1 = ({
            "CategoryCard[categoryStateToRows]": (state)=>{
                const rows = [];
                Object.values(state).forEach({
                    "CategoryCard[categoryStateToRows > (anonymous)()]": (typeState)=>{
                        typeState.rows.forEach({
                            "CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach()]": (row)=>{
                                let issue = "";
                                Object.entries(catalog?.[id] || {}).forEach({
                                    "CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach() > (anonymous)()]": (t2)=>{
                                        const [, subtypeObj] = t2;
                                        if (Array.isArray(subtypeObj.problems) && row.problems.some({
                                            "CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach() > (anonymous)() > row.problems.some()]": (p)=>subtypeObj.problems.includes(p)
                                        }["CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach() > (anonymous)() > row.problems.some()]"])) {
                                            row.problems.forEach({
                                                "CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach() > (anonymous)() > row.problems.forEach()]": (prob)=>{
                                                    if (subtypeObj.problems.includes(prob) && !issue) {
                                                        issue = prob;
                                                    }
                                                }
                                            }["CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach() > (anonymous)() > row.problems.forEach()]"]);
                                        }
                                    }
                                }["CategoryCard[categoryStateToRows > (anonymous)() > typeState.rows.forEach() > (anonymous)()]"]);
                                rows.push({
                                    issue: issue || row.problems[0] || "",
        ...
        })["CategoryCard[categoryStateToRows]"];
        $[1] = catalog;
        $[2] = id;
        $[3] = t1;
    } else {
    ...
    const categoryStateToRows = t1;
    const rowsToCategoryState = _CategoryCardRowsToCategoryState;
    let t2;
    if ($[4] !== categoryStateToRows || $[5] !== value) {
        t2 = ({
            "CategoryCard[useState()]": ()=>categoryStateToRows(value || {})
        })["CategoryCard[useState()]"];
        $[4] = categoryStateToRows;
        $[5] = value;
        $[6] = t2;
    } else {
        t2 = $[6];
    }
    const [rows_1, setRows] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t2);
    let t3;
    if ($[7] !== categoryStateToRows || $[8] !== value) {
        t3 = ({
            "CategoryCard[useEffect()]": ()=>{
                setRows(categoryStateToRows(value || {}));
            }
        })["CategoryCard[useEffect()]"];
        $[7] = categoryStateToRows;
        $[8] = value;
        $[9] = t3;
    } else {
        t3 = $[9];
    ...
    const t12 = rows_1.map({
        "CategoryCard[rows_1.map()]": (row_3, i_2)=>{
            const subtypesAvailable = row_3.issue && catalog?.[category]?.[row_3.issue] ? catalog[category][row_3.issue].problems || [] : [];
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            row_3.openStep === 3 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "mt-2 text-sm text-zinc-500",
                                children: [
                                    row_3.speed ? `Speed: ${row_3.speed}` : "",
                                    row_3.notes ? ` • ${row_3.notes}` : ""
                                ]
                            }, void 0, true, {
                                fileName: "[project]/frontend/src/app/components/CategoryCard.tsx",
                                lineNumber: 261,
...
_s(CategoryCard, "ZBN+nXRs70EVQcd0XfCJnGEwCS4=");
_c = CategoryCard;
...
//# sourceMappingURL=frontend_src_a5db9cc6._.js.map